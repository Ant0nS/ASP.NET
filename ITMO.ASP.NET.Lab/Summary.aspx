<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="ITMO.ASP.NET.Lab.Summary" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tbody>
                    <% var yesData = ITMO.ASP.NET.Lab.Models.ResponseRepository.GetRepository().GetAllResponses().Where(r => r.WillAttend.Value);
